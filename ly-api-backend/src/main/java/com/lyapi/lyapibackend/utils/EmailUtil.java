package com.lyapi.lyapibackend.utils;

import com.lyapi.lyapibackend.config.EmailConfig;
import com.lyapi.lyapibackend.constant.EmailConstant;
...
public class EmailUtil {
    ...
    public static String buildEmailContent(String emailHtmlPath, String captcha) {
        ...
        // 替换html模板中的参数
        return MessageFormat.format(buffer.toString(), captcha, EmailConstant.EMAIL_TITLE, EmailConstant.EMAIL_TITLE_ENGLISH);
    }
