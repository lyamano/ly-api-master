...
import com.lyapi.lyapibackend.model.dto.interfaceinfo.*;
import com.lyapi.lyapibackend.model.entity.User;
import com.lyapi.lyapibackend.model.enums.InterfaceStatusEnum;
...
import com.lyapi.lyapisdk.model.request.CurrencyRequest;
...
public class InterfaceInfoController {
    ...
    public BaseResponse<Object> invokeInterface(@RequestBody InvokeRequest invokeRequest, HttpServletRequest request) {
        ...
        try {
            LyApiClient lyApiClient = new LyApiClient(accessKey, secretKey);
            ...
            ResultResponse response = apiService.request(lyApiClient, currencyRequest);
