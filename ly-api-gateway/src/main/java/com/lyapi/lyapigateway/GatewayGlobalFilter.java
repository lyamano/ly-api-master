...
import com.lyapi.lyapicommon.common.ErrorCode;
import com.lyapi.lyapicommon.model.dto.RequestParamsField;
import com.lyapi.lyapicommon.model.emums.InterfaceStatusEnum;
import com.lyapi.lyapicommon.model.entity.InterfaceInfo;
import com.lyapi.lyapicommon.model.vo.UserVO;
import com.lyapi.lyapicommon.service.inner.InnerInterfaceInfoService;
...
import com.lyapi.lyapigateway.exception.BusinessException;
import com.lyapi.lyapigateway.utils.RedissonLockUtil;
...
import static com.lyapi.lyapicommon.model.emums.UserAccountStatusEnum.BAN;
import static com.lyapi.lyapisdk.utils.SignUtils.getSign;
                ...
                for (RequestParamsField requestParamsField : list) {
                    if ("是".equals(requestParamsField.getRequired())) {
                        if (StringUtils.isBlank(queryParams.getFirst(requestParamsField.getFieldName())) || !queryParams.containsKey(requestParamsField.getFieldName())) {
                            // todo 请求参数有误，ip为必选项，详细参数请参考API文档：https://doc.qimuu.icu/
